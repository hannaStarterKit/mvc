...
<body>
	...
	<section class="container">
		<div class="row">
			<div class="col-sm-6 col-md-3" style="padding-bottom: 15px">
				<p>
					<a href="/webstore/search/searchBooks" class="btn btn-default">
						<span class="glyphicon-info-sign glyphicon" /></span> Search books
					</a>
				</p>
	...
	<section class="container">
		<div class="row">
			<div class="col-sm-6 col-md-3" style="padding-bottom: 15px">
				<p>
					<a href="/webstore/login" class="btn btn-default">
						<span class="glyphicon-info-sign glyphicon" /></span> Login
					</a>
				</p>
